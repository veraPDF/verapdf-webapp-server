...
import org.verapdf.webapp.jobservice.model.deserializer.StringToJobStatusConverter;
import org.verapdf.webapp.jobservice.model.deserializer.StringToUUIDConverter;
...
public class JobDTO {
	...
	@JsonDeserialize(converter = StringToJobStatusConverter.class)
